package com.spacemanapp.myapp.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("SpacemanApp");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("SpacemanApp");
        ...
        config.getMapConfigs().put("com.spacemanapp.myapp.domain.*", initializeDomainMapConfig(jHipsterProperties));
